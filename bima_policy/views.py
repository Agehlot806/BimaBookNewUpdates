...
def slab_payoutformshow(request, id):
    if request.method == "POST":
        ...
        # fuel_type = request.POST['fuel_type']
        # cpa = request.POST['cpa']
        # rewards_on = request.POST['rewards_on']
        # rewards_age = request.POST['rewards_age']
        # self_rewards_on = request.POST['self_rewards_on']
        # self_rewards_age = request.POST['self_rewards_age']
        
        # return redirect("/slab/slab_payoutform/")
    else:
